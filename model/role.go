...
func MakeDefaultRoles() map[string]*Role {
	...
	roles[SCHOOL_TEACHER_ROLE_ID] = &Role{
		Name:        "school_teacher",
		DisplayName: "authentication.roles.school_teacher.name",
		Description: "authentication.roles.school_teacher.description",
		Permissions: []string{
			PERMISSION_MANAGE_KID.Id,
			PERMISSION_MANAGE_CLASS.Id,
			PERMISSION_MANAGE_ACTIVITY.Id,
		},
		SchemeManaged: true,
		BuiltIn:       true,
	}

	roles[SCHOOL_PARENT_ROLE_ID] = &Role{
		Name:        "school_parent",
		DisplayName: "authentication.roles.school_parent.name",
		Description: "authentication.roles.school_parent.description",
		Permissions: []string{
			PERMISSION_MANAGE_KID.Id,
		},
		SchemeManaged: true,
		...
		Permissions: append(
			append(
				append(
					...
					roles[SCHOOL_PARENT_ROLE_ID].Permissions...,
				),
				roles[SCHOOL_TEACHER_ROLE_ID].Permissions...,
			),
