...
const (
	...
	SCHOOL_PARENT_ROLE_ID  = "school_parent"
	SCHOOL_TEACHER_ROLE_ID = "school_teacher"
	SCHOOL_ADMIN_ROLE_ID   = "school_admin"

	BRANCH_ACCOUNTANT_ROLE_ID = "branch_accountant"
	BRANCH_ADMIN_ROLE_ID      = "branch_admin"

	CLASS_TEACHER_ROLE_ID = "class_teacher"
	CLASS_PARENT_ROLE_ID  = "class_parent"
...
func MakeDefaultRoles() map[string]*Role {
	...
	roles[SCHOOL_ADMIN_ROLE_ID] = &Role{
		Name:        "school_admin",
		DisplayName: "authentication.roles.school_admin.name",
		Description: "authentication.roles.school_admin.description",
		Permissions: []string{
			PERMISSION_MANAGE_SCHOOL.Id,
			...
			PERMISSION_CREATE_KID.Id,
			PERMISSION_MANAGE_KID.Id,
		},
		SchemeManaged: true,
		BuiltIn:       true,
	}
	...
	roles[BRANCH_ADMIN_ROLE_ID] = &Role{
		...
		Permissions: []string{
			...
			PERMISSION_LIST_BRANCH_CLASSES.Id,
			PERMISSION_VIEW_BRANCH.Id,
			PERMISSION_REMOVE_USER_FROM_CLASS.Id,
			PERMISSION_MANAGE_CLASS.Id,
			PERMISSION_CREATE_CLASS.Id,
			PERMISSION_MANAGE_CLASS_ROLES.Id,
			PERMISSION_LIST_CLASS_KIDS.Id,
			PERMISSION_VIEW_CLASS.Id,
			PERMISSION_CREATE_KID.Id,
			PERMISSION_MANAGE_KID.Id,
		},
		SchemeManaged: true,
	...
	roles[BRANCH_ACCOUNTANT_ROLE_ID] = &Role{
		Name:        "branch_admin",
		DisplayName: "authentication.roles.branch_accountant.name",
		Description: "authentication.roles.branch_accountant.description",
		Permissions: []string{
			PERMISSION_LIST_BRANCH_CLASSES.Id,
			PERMISSION_VIEW_BRANCH.Id,
			PERMISSION_LIST_CLASS_KIDS.Id,
	...
	roles[CLASS_TEACHER_ROLE_ID] = &Role{
		Name:        "class_teacher",
		DisplayName: "authentication.roles.class_teacher.name",
		Description: "authentication.roles.class_teacher.description",
		Permissions: []string{
			PERMISSION_MANAGE_CLASS.Id,
			PERMISSION_LIST_CLASS_KIDS.Id,
			PERMISSION_VIEW_CLASS.Id,
	...
	roles[CLASS_PARENT_ROLE_ID] = &Role{
		Name:        "class_parent",
		DisplayName: "authentication.roles.class_parent.name",
		Description: "authentication.roles.class_parent.description",
		Permissions: []string{
			PERMISSION_LIST_CLASS_KIDS.Id,
			PERMISSION_VIEW_CLASS.Id,
			PERMISSION_MANAGE_KID.Id,
				...
				append(
					append(
						append(
							...
							roles[CLASS_PARENT_ROLE_ID].Permissions...,
						),
						roles[CLASS_TEACHER_ROLE_ID].Permissions...,
					),
					roles[BRANCH_ACCOUNTANT_ROLE_ID].Permissions...,
				),
				roles[BRANCH_ADMIN_ROLE_ID].Permissions...,
			),
			roles[SCHOOL_ADMIN_ROLE_ID].Permissions...,
		),
		SchemeManaged: true,
		BuiltIn:       true,
	}
